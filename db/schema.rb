...
ActiveRecord::Schema.define(version: 2018_10_26_045031) do
  ...
  create_table "counselling_pages", force: :cascade do |t|
    t.text "body"
  end

  create_table "mindfulness_pages", force: :cascade do |t|
    t.text "body"
  end
