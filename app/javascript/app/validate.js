...
(function (root, factory) {
  ...
  validate.showError = function (field, error, options) {
    ...
    // Remove valid class from field
    field.classList.remove(localSettings.fieldValidClass);
    ...
    // If not, create one
    var message = field.form.querySelector('.' + localSettings.errorMessageClass + '#error-for-' + id );
    if (!message) {
      message = document.createElement('div');
      message.className = localSettings.errorMessageClass;
  ...
  validate.removeError = function (field, options) {
    ...
    field.classList.add(localSettings.fieldValidClass);
  ...
  validate.destroy = function () {
    ...
    // Remove all errors
    var fields = document.querySelectorAll(settings.errorMessageClass);
    for (var i = 0; i < fields.length; i++) {
